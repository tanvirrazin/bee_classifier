...
def process_detections(detections_record, categories, iou_threshold):
...
def display(confusion_matrix, categories, output_path, iou_threshold):
    print("\n\nIoU:{}".format(iou_threshold))
    print("-----------------------\nConfusion Matrix:")
...
def main(argv):
    ...
    for iou_threshold in IOU_THRESHOLDS:
    	confusion_matrix = process_detections(FLAGS.detections_record, categories, iou_threshold)
    	display(confusion_matrix, categories, FLAGS.output_path, iou_threshold)
