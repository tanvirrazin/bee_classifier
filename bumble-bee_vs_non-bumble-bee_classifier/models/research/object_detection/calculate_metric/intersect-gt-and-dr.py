...
GT_PATH = os.path.join(parent_path, 'object_detection', 'calculate_metric', 'input','ground-truth')
DR_PATH = os.path.join(parent_path, 'object_detection', 'calculate_metric', 'input','detection-results')
